...
fun Metric.formatValue(value: Float): String = when (this) {
    ...
    Metric.TOTAL_CALORIES, Metric.FOOD, Metric.FIBER, Metric.CARBS, Metric.PROTEIN, Metric.FAT, Metric.SATURATED_FAT, Metric.SUGAR, Metric.CALORIC_BALANCE -> "%.0f".format(value)
}
