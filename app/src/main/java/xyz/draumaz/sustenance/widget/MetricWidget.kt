...
import xyz.draumaz.sustenance.data.MetricKind
    ...
    Column(
        ...
        when {
            ...
            points.size < 2 -> {
                ...
                Text(context.getString(xyz.draumaz.sustenance.R.string.no_recent_data), style = TextStyle(color = GlanceTheme.colors.onSurfaceVariant, fontSize = 12.sp))
            }
            else -> {
                Text(value, style = TextStyle(color = GlanceTheme.colors.onSurface, fontWeight = FontWeight.Bold, fontSize = 30.sp))
